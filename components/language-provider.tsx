...
const translations = {
  ...
  ru: {
    ...
    locationValue: "Дания",
    contactError: "Не удалось отправить. Напишите мне напрямую:",
    now: "Сейчас",
    nowSubtitle:
      "Что я сейчас строю, изучаю и куда двигаюсь.",
    nowBuilding: "Разрабатываю",
    nowBuildingBody:
    ...
    writing: "Пишу",
    seeAllOnMedium: "Смотреть все на Medium",
    writingFallback: "Я пишу о .NET, Go и разработке под iOS на Medium.",
    githubActivity: "Активность на GitHub",
    githubActivitySubtitle: "Реальные данные из публичного API GitHub.",
    ghRepos: "Репозитории",
    ghStars: "Звёзды",
    ghForks: "Форки",
    ghLanguages: "Языки по репозиториям",
    ghLastPush: "Последний push",
  },
  et: {
    playHere: "Kuula siin",
    closePlayer: "Sulge",
