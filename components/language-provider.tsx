...
const translations = {
  ...
  ru: {
    ...
    expWebDevelopment: "Разработка современных и отзывчивых веб-приложений",
  ...
  et: {
    ...
    expWebDevelopment: "Kaasaegsete ja reageerivate veebirakenduste arendamine",
    ...
    expCodeReview: "Koodi ülevaatus ja noorte arendajate juhendamine",
    // Project media translations
